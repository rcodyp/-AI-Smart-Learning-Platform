...
def main():
    ...
    if "questions" not in st.session_state:
        st.title("AI Generated Quizze : MCQ")
    ...
    # MCQ page
        ...
        if st.session_state.get("submitted", False):
            ...
            perc = score/len(attempted_questions)
            



            if perc >= 0.6:
                url = "https://www.youtube.com/watch?v=IymPq7ik29k&list=PLwGdqUZWnOp2Z3eFOgtOGvOWIk4e8Bsr_"  # Include the protocol
                st.markdown(f"Congratulation, Well done upgrade your learning: [Youtube]({url})")
            else:
                urlv = "https://www.youtube.com/watch?v=6mbwJ2xhgzM&list=PLu0W_9lII9agiCUZYRsvtGTXdxkzPyItg"  # Include the protocol
                st.markdown(f"Work hard and learn from basics: [Youtube]({urlv})")
